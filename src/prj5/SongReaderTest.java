...
public class SongReaderTest extends TestCase
{
    ...
    /**
     * test read SongListNoGenreRepeats.csv file
     */
    public void testReadSureyFile3()
    {
        String file2 = "SongListNoGenreRepeats.csv";
        SongReader sr = new SongReader(file2);

        LinkedList<Song> songList2 = sr.readSongFile(file2);
        
        assertEquals(songList2.getLength(), 17);
    }
}
